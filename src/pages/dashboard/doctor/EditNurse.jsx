...
const EditNurse = ({ id, closeEditModal }) => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            try {
                const response = await axios.get(`${baseUrl}/nurses.php?id=${id}`);
            ...
            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        <h3 className="text-lg mt-2 leading-6 font-medium text-gray-900 uppercase" id="modal-title">Edit Nurse</h3>
